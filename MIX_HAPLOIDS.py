...
The simulation supports five scenarios: (a) trisomy with two matched haplotypes
...
transition between SPH to BPH along the chromosome, (d) disomy and (e) monosomy.
