...
def main(depth,sp,chr_id,read_length,min_reads,max_reads):
    ...
    runInParallel(*func)
    MixHaploids_wrapper(f'{work_dir:s}{C[0]:s}.{chr_id:s}.hg38.obs.p', f'{work_dir:s}{C[1]:s}.{chr_id:s}.hg38.obs.p', f'{work_dir:s}{C[2]:s}.{chr_id:s}.hg38.obs.p', read_length=read_length, depth=depth, scenarios=('monosomy','disomy','SPH','BPH'),output_dir=work_dir, recombination_spots=[0])
    filenames = (f'mixed3haploids.X{depth:.2f}.{C[0]:s}.{C[1]:s}.{C[2]:s}.{chr_id:s}.recomb.{i:.2f}.obs.p' for i in (0,1))
