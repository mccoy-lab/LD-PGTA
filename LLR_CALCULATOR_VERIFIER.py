...
def joint_frequencies_combo(*alleles,hap_dict,N):           
...
if __name__ != "__main__": 
    ...
    print(joint_frequencies_combo(positions[0],hap_dict=hap_dict,N=N))
    print(joint_frequencies_combo(positions[:4],hap_dict=hap_dict,N=N))
